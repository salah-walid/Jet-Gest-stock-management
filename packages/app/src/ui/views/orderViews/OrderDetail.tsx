...
class ProviderOrderDetail extends Component<Props>{
    ...
    vm: OrderDetailViewModel = new OrderDetailViewModel();
                    ...
                    <div className="container justify-content-center">
                        {
                            ...
                            : <div>
                                ...
                                <div className="row align-items-center justify-content-center">
                                    ...
                                    <div className="col-lg-6 col fs-4">
                                        Client : {this.vm.order?.client?.name} {this.vm.order?.client?.lastName}
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        {
                                            this.vm.order?.orderList.map((item, index) => {
                                                return (
                                                    <ProductOrderCard key={index} index={index} allowModification={false} productOrder={item}/>
                                                )
                                            })
                                        }
                                    </tbody>
                                ...
                                <div className="text-right mt-4">
                                    <h2 className="fs-3 mb-3">
                                        Total HT : {this.vm.order?.totalHT} DA
                                    </h2>
                                    <h2 className="fs-3 mb-3">
                                        TVA : {this.vm.order?.tvaAmount} DA
                                    </h2>
                                    <h2 className="fs-3 mb-3">
                                        Total TTC : {this.vm.order?.totalTTC} DA
                                    </h2>
                                    <h2 className="fs-3 mb-3">
...

                                {
                                    ...
                                    ? <div className="row">
                                        ...
                                        <button className="col-lg-3 col offset-lg-1 offset-0 btn btn-seconday border fs-6 text-left" onClick={(e) => {window.open(
                                            `${ApiService.endPoint}gestion/printInvoice/${this.vm.order?.id}`, 
                                            "_blank")}}>
                                            <img src={printerImg} className="btn-image"></img> Imprimer
                                        </button>

                                        <button className="col-lg-3 col offset-lg-1 offset-0 btn btn-seconday border fs-6 text-left" onClick={(e) => {Routes.navigator.push(Routes.orderForm + "/" + this.vm.order?.id)}}>
                                            <img src={editImg} className="btn-image"></img> Modifier
                                        </button>

                                        <button className="col-lg-3 col offset-lg-1 offset-0 btn btn-primary fs-6 text-left" onClick={(e) => this.vm.deleteOrder()} >
