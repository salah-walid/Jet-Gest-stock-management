...
import ProviderOrderFormViewModel from '../../viewmodels/providerOrderViewModel/providerOrderFormViewModel';
...
class ProviderOrderForm extends Component<Props> {

    vm: ProviderOrderFormViewModel = new ProviderOrderFormViewModel();
            ...
            <div className='container-fluid'>
                ...
                <div className="my-4">
                    <h1 className="display-1 text-center mb-5">
                        {
                            ...
                            ? "Nouvelle pièce fournisseur"
                            : "Modifier pièce fournisseur"
                        }
                    </h1>
                    ...
                    <form className="g-3 needs-validation" ref={this.vm.formRef} onSubmit={this.vm.submit} noValidate>
                        <div className="row">
                            <div className="input-group has-validation col">
                                <input 
                                    type="text" 
                                    name="name"
                                    value={`${this.vm.providerOrder.provider?.name ?? ""} ${this.vm.providerOrder.provider?.lastName ?? ""}`}
                                    className="form-control" 
                                    pattern=".{3,}" 
                                    required 
                                />
                                <div className="input-group-append">
                                    <a className="col offset-1 btn btn-seconday border fs-6 text-left" onClick={(e) => this.vm.modifyProvider()}>
                                        Modifier
                                    </a>
                                </div>
                        ...
                        <div className="mt-4">
                            <a className="btn btn-primary" onClick={(e) => this.vm.addEntry()}>
                        ...
                        <p className="text-end fs-4 my-4">
                            Total : {this.vm.providerOrder.total.toFixed(2)} DA
                        </p>
...
export default observer(ProviderOrderForm)
