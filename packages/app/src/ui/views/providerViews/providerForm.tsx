...
import ProviderFormViewModel from '../../viewmodels/providerViewModels/providerFormViewModel';
...
class ProviderForm extends Component<Props> {

    vm: ProviderFormViewModel = new ProviderFormViewModel();
                                    ...
                                    <td> 
                                        <div className="input-group has-validation">
                                            <input 
                                                type="text"
                                                name="name"
                                                value={this.vm.provider.name}
                                                onChange={(e) => {this.vm.provider.name = e.target.value; this.vm.inputChanged(e)}} 
                                    ...
                                    <td> 
                                        <div className="input-group has-validation">
                                            <input 
                                                type="text"
                                                name="lastName"
                                                value={this.vm.provider.lastName}
                                                onChange={(e) => {this.vm.provider.lastName = e.target.value; this.vm.inputChanged(e)}} 
                                                className="form-control" 
                                                id="lastNameForm" 
                                                pattern=".{3,}" 
                                                required 
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        <div className="input-group has-validation">
                                            <textarea 
                                                name="adress"
                                                value={this.vm.provider.adress}
                                                onChange={(e) => {this.vm.provider.adress = e.target.value; this.vm.inputChanged(e)}} 
                                                className="form-control" 
                                                id="adressForm"
                                                required 
                                            >
                                    ...
                                    <td> 
                                        <div className="input-group has-validation">
                                            <input 
                                                type="text"
                                                name="city"
                                                value={this.vm.provider.city}
                                                onChange={(e) => {this.vm.provider.city = e.target.value; this.vm.inputChanged(e)}} 
                                                className="form-control" 
                                                id="cityForm" 
                                                pattern=".{3,}" 
                                                required 
                                    ...
                                    <td> 
                                        <div className="input-group has-validation">
                                            <input 
                                                type="text"
                                                name="nMF"
                                                value={this.vm.provider.nMF}
                                                onChange={(e) => {this.vm.provider.nMF = e.target.value; this.vm.inputChanged(e)}} 
                                                className="form-control" 
                                                id="NMFForm" 
                                                pattern=".{3,}" 
                                                required 
                                    ...
                                    <td> 
                                        <div className="input-group has-validation">
                                            <input 
                                                type="text"
                                                name="nRC"
                                                value={this.vm.provider.nRC}
                                                onChange={(e) => {this.vm.provider.nRC = e.target.value; this.vm.inputChanged(e)}} 
                                                className="form-control" 
                                                id="NRCForm" 
                                                pattern=".{3,}" 
                                                required 
                                    ...
                                    <td> 
                                        <div className="input-group has-validation">
                                            <input 
                                                type="text"
                                                name="nAI"
                                                value={this.vm.provider.nAI}
                                                onChange={(e) => {this.vm.provider.nAI = e.target.value; this.vm.inputChanged(e)}} 
                                                className="form-control" 
                                                id="NAIForm" 
                                                pattern=".{3,}" 
                                                required 
